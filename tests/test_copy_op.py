...
def test_generate_sarif():
    ...
    with open(sarif_schema_file, "rb") as f_schema:
        sarif_schema = json.load(f_schema)
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ouput_file_path = os.path.join(tmp, "copied.json")
        ...
        with open(ouput_file_path, "rb") as f_out:
            ...
            "tool": {
                "driver": {
                    ...
                    "properties": {
                        ...
                        "processed": output_sarif["runs"][0]["conversion"]["tool"]["driver"]["properties"]["processed"],
                    },
                }
            },
            "invocation": {
